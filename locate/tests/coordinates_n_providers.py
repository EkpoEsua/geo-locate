"""Contains coordinates parameters for each polygon representing a geographic area in geojson format
...
provider_x_service_areas = {
    "GIGM":[
      {
        "name": "kubwa",
        "price": 500,
        "coordinates": kubwa_coordinates
      },
      {
        "name": "dutse",
        "price": 600,
        "coordinates": dutse_coordinates
      },
      {
        "name": "gwarinpa",
        "price": 1000,
        "coordinates": gwarinpa_coordinates
      }
    ],
    "Bolt":[
      {
    ...
    "YSG":[
      ...
      },
      {
        "name": "maitama",
        "price": 1700,
        "coordinates": maitama_coordinates
      },
    ],
    "GAM":[
      {
